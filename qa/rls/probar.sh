...
ASIG="update funnel_contratos set verificador_id=900041 where prospecto_id=900101;"
...
caso "el gerente de ventas asigna el verificador" "900041" gerente_ventas "$CON_CLOSER $SEG $ADM5 select funnel_cerrar_contrato(900101,'x','y',900021,900031,null,4);" "select funnel_contrato_asignar_verificador($CID,900041); $DUE select verificador_id from funnel_contratos where id=$CID;"
