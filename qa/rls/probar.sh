...
caso "nadie del equipo llama a la función de horarios directo" "false" _dueno "" "select has_function_privilege('authenticated','public.funnel_horario_problema(bigint,timestamptz,bigint)','execute')::text;"
